...
import dummy_profile from '/assets/avatar.png'
...
const ProfilePage = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    // we call FileReader -- because we want to read file as string
  ...
  return (
    <div className="h-screen pt-20">
      <div className="max-w-2xl mx-auto p-4 py-8">
        <div className="bg-[#f7f7f7] rounded-xl p-6 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                src={selectedImg || authUser.profilePic || dummy_profile}
                alt="Profile"
